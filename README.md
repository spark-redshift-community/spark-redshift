...
- **Without build tool**:
    ...
    spark-submit \
      --deploy-mode cluster \
      --master yarn \
      --packages com.amazon.redshift:redshift-jdbc42:2.1.0.33,org.apache.spark:spark-avro_2.12:3.5.6,io.github.spark-redshift-community:spark-redshift_2.12:6.3.0-spark_3.5 \
      my_script.py
    ```
