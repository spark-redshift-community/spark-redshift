...
trait AggregateCountCorrectnessSuite extends IntegrationPushdownSuiteBase {
  val testCount00: TestCase = TestCase(
    ...
    s"""SELECT ( COUNT ( 1 ) ) AS "SQ_1_COL_0"
       ...
       | AS "SQ_0" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount17: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       ...
       | SELECT ( "SQ_0"."COL_SMALLINT_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
  ...
  val testCount17_2: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( DISTINCT "SQ_1"."SQ_1_COL_0" ) ) AS"SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_SMALLINT_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0") ASC NULLS FIRST ) AS "SQ_3"
  ...
  val testCount27: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_INT_RUNLENGTH" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount37: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_BIGINT_MOSTLY8" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount49: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_DECIMAL_38_37_MOSTLY32" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount58: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_FLOAT4_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount59: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_FLOAT8_BYTEDICT" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount60: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_BOOLEAN_RAW" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount61: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_BOOLEAN_RUNLENGTH" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount62: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_BOOLEAN_ZSTD" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount63: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_BOOLEAN_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount74: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_CHAR_MAX_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount84: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_VARCHAR_MAX_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount97: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_DATE_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount107: TestCase = TestCase(
    ...
    s"""SELECT * FROM ( SELECT * FROM (
       | SELECT ( "SQ_1"."SQ_1_COL_0" ) AS "SQ_2_COL_0",
       | ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_1" FROM (
       | SELECT ( "SQ_0"."COL_TIMESTAMP_ZSTD" ) AS "SQ_1_COL_0" FROM (
       | SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" ) AS "SQ_1"
       | GROUP BY "SQ_1"."SQ_1_COL_0" ) AS "SQ_2"
       | ORDER BY ( "SQ_2"."SQ_2_COL_0" ) ASC NULLS FIRST ) AS"SQ_3"
       | ORDER BY ( "SQ_3"."SQ_2_COL_0" ) ASC NULLS FIRST
  ...
  val testCount110: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_RAW" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount111: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_BYTEDICT" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount112: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_DELTA" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount113: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_DELTA32K" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount114: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_LZO" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount115: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_RUNLENGTH" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
  ...
  val testCount116: TestCase = TestCase(
    ...
    Seq(Row(5000)), // expectedResult
    s"""SELECT ( COUNT ( "SQ_1"."SQ_1_COL_0" ) ) AS "SQ_2_COL_0"
       | FROM ( SELECT ( "SQ_0"."COL_TIMESTAMPTZ_ZSTD" ) AS "SQ_1_COL_0"
       | FROM ( SELECT * FROM $test_table AS "RCQ_ALIAS" ) AS "SQ_0" )
       | AS "SQ_1" LIMIT 1""".stripMargin // expectedPushdownStatement
  )
}