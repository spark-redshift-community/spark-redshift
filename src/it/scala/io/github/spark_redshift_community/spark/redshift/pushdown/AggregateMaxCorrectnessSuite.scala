...
trait AggregateMaxCorrectnessSuite extends IntegrationPushdownSuiteBase {
  ...
  val testMax100: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-10 04:08:15 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax101: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-16 05:30:44 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax102: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-16 21:18:03 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax103: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-16 10:31:55 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax104: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-15 03:45:35 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax105: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-14 22:00:57 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
  ...
  val testMax106: TestCase = TestCase(
    ...
    Seq(Row(Timestamp.from(ZonedDateTime.parse("2018-10-15 19:50:18 UTC", formatter).toInstant))),
    // expectedResult
    s"""SELECT ( MAX ( "SUBQUERY_1"."SUBQUERY_1_COL_0" ) ) AS "SUBQUERY_2_COL_0"
